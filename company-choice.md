...
## Departamentos del proyecto que me interesan para Automatizar
...
* **Logística inversa** Para desarrollar un sistema que gestione mejor las devoluciones y las razones de las mismas.
...
* **Dirección Ejecutiva CEO:** Para unir toda la información, analizarla y mostrarla en un "dashboard" que permita hacer un monitorio en tiempo real.
